...
<div class="margin clearfix" >
 ...
 <div class="hide_style clearfix">
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="20" data-color="#D15B47"><span class="percent">20</span>%</div><span class="name">未付款</span></div>									
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="55" data-color="#87CEEB"><span class="percent">55</span>%</div><span class="name">未接单</span></div>									
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="90" data-color="#87B87F"><span class="percent">90</span>%</div><span class="name">未配送</span></div>
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="30" data-color="#d63116"><span class="percent">30</span>%</div><span class="name">派送中</span></div>
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="60" data-color="#ff6600"><span class="percent">60</span>%</div><span class="name">已完成</span></div>
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="40" data-color="#2ab023"><span class="percent">40</span>%</div><span class="name">退款中</span></div>
   <div class="proportion"> <div class="easy-pie-chart percentage" data-percent="46" data-color="#1e3ae6"><span class="percent">46</span>%</div><span class="name">已退款</span></div>
 </div>
 </div>
...
<div class="order_list" id="order_list">
  <div class="h_products_list clearfix" id="products_list">
       <div id="scrollsidebar" class="left_Treeview">
        ...
        <div class="widget-box side_content" >
         ...
         <ul class="b_P_Sort_list">
             ...
             <li><i class="fa fa-sticky-note pink "></i> <a href="#">未付款</a></li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="#">未配送</a> </li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="#">派送中</a></li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="#">已完成</a></li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="#">退款中</a></li>
             <li><i class="fa fa-sticky-note grey "></i> <a href="#">已退款</a></li>
            </ul>
        </div>
       </div>
      </div>  
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="250px">配送信息</th>
				<th width="100px">总价</th>
				<th width="100px">菜品</th>
                <th width="160px">订单开始时间</th>				
                <th width="140px">订单结束时间</th>				
				<th width="180px">所属类型</th>
                <th width="120px">骑手</th>
	...
	<tbody id="tbody123">
     ...
     <td><a href="#">yuxinzhe</a></td>
     <td><a href="#">详情</a></td>
     <td>￥56</td>
     <td><a href="#">详情</a></td>
     <td>2018-06-20 13：00</td>
